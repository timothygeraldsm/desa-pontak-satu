      ...
      <div>
        ...
        <div className="prose prose-lg text-gray-700">
          <p>
            ...
            bahasa lokal Minahasa yang berarti “tempat tinggi” atau “wilayah yang ditinggikan”. Makna tersebut berkaitan erat
            dengan kondisi geografis daerah yang terletak di dataran yang sedikit lebih tinggi dibandingkan sekitarnya.
          </p>
          <p>
            Ada pula riwayat lisan yang menyebut bahwa Pontak merupakan nama dari seorang tokoh adat di masa lampau yang
            dikenal karena kepemimpinan dan keberaniannya dalam menjaga masyarakat serta wilayahnya. Nama ini kemudian
            diwariskan secara turun-temurun hingga menjadi identitas tetap bagi masyarakat dan wilayah yang kini dikenal
            sebagai Desa Pontak dan wilayah pemekarannya.
          </p>
          <p>
            Desa Pontak Satu lahir dari semangat kolektif masyarakat yang menginginkan pembentukan wilayah administratif baru
            demi pemerataan pembangunan dan peningkatan kualitas pelayanan publik. Pada saat itu, wilayah Desa Pontak induk
            memiliki cakupan yang luas dengan jumlah penduduk yang terus bertambah, sehingga pelayanan pemerintahan dirasa
            tidak lagi efektif dan menyeluruh.
          </p>
          <p>
            Untuk merealisasikan gagasan pemekaran tersebut, masyarakat bersama pemerintah desa membentuk panitia resmi
            yang bertugas mempersiapkan segala hal terkait pemekaran. Panitia ini dipimpin oleh Alm. Bapak Arnold Rembet sebagai
            Ketua, Alm. Bapak Lole Sumangkut sebagai Sekretaris, dan Alm. Bapak Orlo Rantung sebagai Bendahara.
          </p>
          <p>
            Setelah melalui proses panjang, Desa Pontak Satu resmi dimekarkan dan ditetapkan sebagai desa definitif pada tanggal
            27 Juli 2004 oleh Bupati Minahasa Selatan saat itu, Bapak Ramoy Markus Luntungan. Pada saat awal pembentukannya,
            Desa Pontak Satu terdiri dari 175 Kepala Keluarga dengan total penduduk sebanyak 637 jiwa.
          </p>
          <p>
            Secara geografis, Desa Pontak Satu memiliki batas-batas wilayah sebagai berikut: sebelah utara berbatasan dengan
            Sungai Tumicakal, sebelah selatan dengan wilayah Poopo dan Poopo Utara, sebelah timur dengan Sungai Ranoyapo,
            dan sebelah barat dengan Desa Raanan serta Desa Lalumpe.
          </p>
          <p>
            Kepemimpinan di Desa Pontak Satu terus berlangsung secara demokratis dan berjalan sesuai ketentuan peraturan
            perundang-undangan. Seiring waktu, desa ini mengalami beberapa kali pergantian Hukum Tua yang masing-masing membawa
            kontribusi dalam pembangunan desa.
          </p>
          <p>
            Sejak berdiri hingga saat ini, Desa Pontak Satu telah mengalami berbagai perkembangan baik dari segi infrastruktur,
            pelayanan publik, pemberdayaan masyarakat, maupun pembangunan sosial dan ekonomi.
          </p>
          <p>
            Hingga saat ini, Desa Pontak Satu terus bergerak maju dengan berbagai program pembangunan, pembinaan kemasyarakatan,
            serta kegiatan-kegiatan berbasis budaya dan kearifan lokal.
          </p>
        </div>
      </div>
      <div>
